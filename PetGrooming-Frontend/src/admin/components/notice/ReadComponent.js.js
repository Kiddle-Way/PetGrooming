...
import { getOne, deleteOne } from "../../../common/api/noticeApi";
  ...
  return (
    <div className="border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-end p-4">
        <button
          type="button"
          className="rounded p-2 m-2 text-xl w-32 text-white bg-orange-500"
          onClick={() => moveToModify(n_num)}
        >
          수정
        </button>
        <button
          type="button"
          className="rounded p-2 m-2 text-xl w-32 text-white bg-red-500"
