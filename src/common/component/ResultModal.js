const ResultModal = ({ title, content, callbackFn }) => {
  return (
    ...
    rounded mt-10 mb-10 px-6 min-w-[600px]"
      >
        <div className="justify-center bg-warning-400 mt-6 mb-6 text-2xl border-4 border-gray-500">
          {title}
        </div>
        ...
        <div className="justify-end flex ">
          <button
            className="rounded bg-blue-500 mt-4 mb-4 px-6 pt-4 pb-4 text-lg textwhite"
            onClick={() => {
              if (callbackFn) {
                callbackFn();
              }
